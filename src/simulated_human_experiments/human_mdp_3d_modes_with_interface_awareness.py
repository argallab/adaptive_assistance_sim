...
if __name__ == "__main__":
    ...
    # print("MODE 1 DISMAB2")
    # print(" ")
    # simulate_trajectories(tuple(max_disamb_state), 2, mdp_list)
    # print("DISMAB3")
    # print(" ")
    # simulate_trajectories(tuple(max_disamb_state), 3, mdp_list)

    # max_disamb_state[-1] = 2
    # print("MODE 2 DISMAB2")
    # print(" ")
    # simulate_trajectories(tuple(max_disamb_state), 2, mdp_list)
    # print("DISMAB3")
    # print(" ")
