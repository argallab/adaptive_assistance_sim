...
MODE_DISPLAY_RADIUS_S = MODE_DISPLAY_RADIUS / SCALE


MODE_DISPLAY_CIRCLE_START_POSITION_S = [
    (3 * VIEWPORT_WS) / 4 + 2.5 * MODE_DISPLAY_RADIUS_S,
    VIEWPORT_HS - 2 * MODE_DISPLAY_RADIUS_S,
]
MODE_DISPLAY_CIRCLE_X_OFFSET_S = 3 * MODE_DISPLAY_RADIUS_S
MODE_DISPLAY_CIRCLE_Y_OFFSET_S = 100 / SCALE
P_UM_GIVEN_A_MODE_DISPLAY_CIRCLE_START_POSITION_S = [
    VIEWPORT_WS / 2 - MODE_DISPLAY_CIRCLE_X_OFFSET_S,
    2 * VIEWPORT_HS / 3,
]

MODE_DISPLAY_TEXT_START_POSITION = [
    (3 * VIEWPORT_W) / 4 + 2.5 * MODE_DISPLAY_RADIUS,
    VIEWPORT_H - 3.5 * MODE_DISPLAY_RADIUS,
]
...
MODE_DISPLAY_TEXT_X_OFFSET = 3 * MODE_DISPLAY_RADIUS
MODE_DISPLAY_TEXT_FONTSIZE = 13
...
class RobotSE2(object):
    ...
    def mode_conditioned_velocity(self, velocity_action):
        ...
        true_velocity[-1] = true_velocity[-1] * -0.65
